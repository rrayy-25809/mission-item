...
dependencies {
    ...
    compileOnly("io.papermc.paper:paper-api:1.21-R0.1-SNAPSHOT") // Use the appropriate version
...
java {
    ...
    toolchain {
        languageVersion = JavaLanguageVersion.of(21) // Minecraft plugins typically use Java 17
    }
}
